...
const animals: AnimalDetail[] = [
  {
    ...
    'primaryStats': { 'healPoint': 40, 'attackPower': 40, 'speed': 5, 'defence': 10, 'weight': 2, 'lifeSpan': 11 },
  ...
  },
  {
    ...
    'primaryStats': { 'healPoint': 260, 'attackPower': 40, 'speed': 75, 'defence': 50, 'weight': 600, 'lifeSpan': 19 },
  ...
  },
  {
    ...
    'primaryStats': { 'healPoint': 90, 'attackPower': 35, 'speed': 120, 'defence': 35, 'weight': 2, 'lifeSpan': 9 },
  ...
  },
  {
    ...
    'level': 1,
    'region': Region.NORTH_AMERICA,
    'primaryStats': { 'healPoint': 1200, 'attackPower': 20, 'speed': 5, 'defence': 20, 'weight': 36000, 'lifeSpan': 61 },
    'secondaryStats': { 'poison': 20 },
  ...
  },
  {
    ...
    'level': 1,
    'region': Region.NORTH_AMERICA,
    'primaryStats': { 'healPoint': 500, 'attackPower': 80, 'speed': 50, 'defence': 150, 'weight': 190, 'lifeSpan': 26 },
  ...
  },
  {
    ...
    'level': 3,
    'region': Region.AFRICA,
    'primaryStats': { 'healPoint': 30, 'attackPower': 5, 'speed': 64, 'defence': 10, 'weight': 1, 'lifeSpan': 18 },
  ...
  },
  {
    ...
    'level': 5,
    'region': Region.EUROPE,
    'primaryStats': { 'healPoint': 300, 'attackPower': 70, 'speed': 46, 'defence': 120, 'weight': 125, 'lifeSpan': 19 },
    'secondaryStats': { 'attackBuff': 10, 'defenseBuff': 10 },
